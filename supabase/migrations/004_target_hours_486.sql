-- Align target hours to 486 across DB. Run after 002.

alter table public.profiles
  alter column target_hours set default 486;

update public.profiles set target_hours = 486 where target_hours = 468;
